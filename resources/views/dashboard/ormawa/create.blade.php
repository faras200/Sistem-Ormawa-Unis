        ...
        <div class="col-md-12" style="padding: 0px 0px !important">
            <div class="card ">
                <div class="card-header card-header-rose card-header-icon">
                    ...
                    <h4 class="card-title">Tambah Organisasi Mahasiswa</h4>
                </div>
                    ...
                    <form method="post" action="/dashboard/ormawa" class="form-horizontal">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <textarea name="visi" class="form-control" id="" rows="7" placeholder="visi organisasi..."></textarea>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <textarea name="misi" class="form-control" id="" rows="7" placeholder="misi organisasi..."></textarea>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <textarea name="profil" class="form-control" id="" rows="7" placeholder="profil organisasi..."></textarea>
